package com.kk2.user.ui.widget.pop;
...
public class CommentOrPraisePopupWindow extends PopupWindow implements View.OnClickListener {
    ...
    public CommentOrPraisePopupWindow(Context context) {
        ...
        this.mPopupWindowHeight = CommonUtils.dpTopx(mContext,38);
        this.mPopupWindowWidth = CommonUtils.dpTopx(mContext,190);
    ...
    public void showPopupWindow(View anchor) {
        ...
        int xOffset = location[0] - mPopupWindowWidth - CommonUtils.dpTopx(mContext,10f);
